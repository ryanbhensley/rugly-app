...
export default function MadonnaProduct() {
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-4xl font-bold mb-2">Madonna Rug</h1>
              <p className="text-2xl text-blue-600 font-bold">${currentPrice.toFixed(2)}</p>
            </div>

            <p className="text-lg text-gray-600">
              Make a bold statement with this vibrant Madonna pop art rug. Featuring a striking 
              pink stencil design, this piece brings iconic 80s pop culture energy to any room. 
              Perfect for music lovers and those who appreciate bold, artistic floor statements.
            </p>
